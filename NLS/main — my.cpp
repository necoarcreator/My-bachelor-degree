...
{
	long long int N = 128, L = N * M_PI / 48;
	//2 * M_PI;
	double T = 5.0;
	...
	if (isSeries) {
		...
		signal = vector<complex<double>>{ firstStartBSOLSerieCollision(x, K, a, b, A, alpha, thetta0, x0, ampGauss, meanGauss, sygGauss) };
	}
	//else {
	//	//riccati
